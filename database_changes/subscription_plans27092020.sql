...
INSERT INTO `subscription_plans` (`id`, `plan_name`, `parent_id`, `plan_description`, `valid_days`, `stripe_price_id`, `max_team_size`, `max_data_sources`, `max_business_users`, `only_for_teams`, `is_active`, `created_at`, `updated_at`) VALUES
