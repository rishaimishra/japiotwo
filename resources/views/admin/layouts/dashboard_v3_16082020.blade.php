...
<body class="fixed-navigation">
    ...
    <nav class="navbar-default navbar-static-side" role="navigation">
     ...
     <img alt="image" class="rounded-circle" src="{{ asset(Auth::user()->pro_img) }}" style="height: 48px;width: 48px;"/>
        ...
        @if(isset($page_data['menu_selected'])&&($page_data['menu_selected'] =='manage_teams')) aria-expanded="true"       @else aria-expanded="false"   @endif 
         >
        ...
        <ul 
        @if(isset($page_data['menu_selected'])&&($page_data['menu_selected'] =='manage_teams')) class="nav nav-second-level collapse in" aria-expanded="true"       @else  class="nav nav-second-level collapse" aria-expanded="false" style="height: 0px;"   @endif         
        >
          ...
          $valid_date=Auth::user()->valid_date;
             $date1_ts = strtotime($valid_date);
                ...
                $diff = $date1_ts - $date2_ts;
                 ...
                 if(Auth::user()->subscription_plans_id=="1"){
                 echo "<b>".$days." ".$da." remaining</b>";
                
                  ?>
                <button type="button" name="back" class="btn btn-primary btn-sm"><a href="{{ url('/upgrade-plan') }}" style="color: white !important;"> UPGRADE 
                </a></button>
                
                <?php  } if(Auth::user()->subscription_plans_id!="1"){ ?>
                <a href="upgrade-plan" style="display: inline !important;">
