                ...
                <div>
                    ...
                    <div class="feed-element">
                        <a href="#" class="float-left">
                            <img alt="image" class="rounded-circle" src="{{ asset('img/a1.jpg') }}">
                        </a>
...
@section('content2')
 <div class="wrapper wrapper-content" style="padding-right:0px !important;">
                ...
                <div class="col-lg-6">
                    <div class="ibox ">
                        <div class="ibox-title">
                            <h5><?php echo $chart_value['name'];?></h5>
                        </div>
                        <div class="ibox-content">
                            <div>
                                <div id="<?php echo $chart_key;?>"></div>
                            </div>
                        </div>
                    </div>
                </div>
