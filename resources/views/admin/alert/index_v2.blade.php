                ...
                <div class="col-lg-12">
                    <div class="tabs-container">
                        <ul class="nav nav-tabs" role="tablist">
                            <li><a class="nav-link active" data-toggle="tab" href="#tab-1"> API Data</a></li>
                            <li><a class="nav-link" data-toggle="tab" href="#tab-2">Datasets</a></li>
...
<?php if(isset($api_responce) && ($api_responce!="")) {
    echo $api_responce;
}?>
...
<div class="ibox " style="margin-bottom: 0px !important;">
                ...
                <form method="post" action="{{ url('/dataset/'.$id) }}">
                              @csrf
                              <br><br>
                                    <strong></strong>
