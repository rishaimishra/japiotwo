...
if(isset($data_set_value_v_value_v['selected'])&&($data_set_value_v_value_v['type']=="select")){
	$data_set_value_v_value_v;
                                         ...
                                         if(is_array($data_set_value_v_value_v['selected'])){											 
                                             foreach($data_set_value_v_value_v['selected'] as $input_key_selected_value_child){
												 ...
												 //$input_key_selected_child[$data_set_value_v_value_v]=$data_set_value_v_value_v;
                                             }
											//  $input_key_selected_child[$data_set_value_v_value_v]=$data_set_value_v_value_v;
                                         } else {
...
if(isset($data_set_value_v_value_v['option'])){
			  ...
			  if($data_set_value_k=="option"){
								...
								<div class="form-group   row <?php echo $input_key_name;?> <?php echo $ids =str_replace(" ","_",$data_set_value_v_key);?>" dclass="<?php echo $input_key_name;?>" id="<?php $ids =str_replace(" ","_",$data_set_value_v_key);?>{{ $ids }}" style="display:none;">
								...
								<?php if($data_set_value_v_value_v['type']=="select"){?>
								 <div class="col-sm-6">
										...
										<?php if($input_key_is_multiple_child=="1"){echo "multiple";}?> >
		...
		<script src="http://webapplayers.com/inspinia_admin-v2.9.3/js/jquery-3.1.1.min.js"></script>
									<script>
