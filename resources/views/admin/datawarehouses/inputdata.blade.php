...
<?php //} ?>
 ...
 <div class="wrapper wrapper-content animated fadeIn" style="padding-right: 0px !important;">
        ...
        <div class="ibox " style="margin-bottom: 0px !important;">
            ...
            <img alt="image" class="" src="{{ asset($datawarehouses->dataware_houses_logo) }}" style="height: 25px;width: 25px;"/>
                            <h5>{{ $datawarehouses->dataware_houses_name }} <small></small></h5>
                    ...
                    <div class="tabs-container">
                        ...
                        <ul class="nav nav-tabs" role="tablist">
                            <li><a class="nav-link active" data-toggle="tab" href="#tab-1">Settings</a></li>
...
<form method="post">
                              ...
                              <br><br>
                                   ...
                                   $dataware_houses_input_credentials= json_decode($datawarehouses->dataware_houses_input_credentials);
                               
                                    foreach($dataware_houses_input_credentials as $data_set_key=>$data_set_value){ 
                  ...
                  $input_key_is_multiple="0";
                                   ...
                                   <label class="col-sm-2 col-form-label">{{ ucfirst($input_key_label) }}</label>
                                   ...
                                   if($input_type=="text"){
                                     ...
                                     value="<?php
                                     if(isset($in_data->$input_key_name)){ echo $in_data->$input_key_name ;}
                                    ?>">
                                      </div>
                                    <?php                                     
                                    }
                                   ...
                                   if($input_type=="password"){
                                     ?>
                                     <div class="col-sm-8">
                                     <input type="password" <?php if(isset($input_key_required)&&($input_key_required=="1")){echo "required";}?> id="{{ $input_key_name }}" name="{{ $input_key_name }}" class="form-control"  placeholder="{{ @$input_placeholder_name }}" 
                                     value="<?php
                                     if(isset($in_data->$input_key_name)){ echo $in_data->$input_key_name ;}
                                    ?>">
                                      </div>
                  ...
                  ?>
                                  ...
                                  <button class="btn btn-primary " name="dataware_houses" type="submit"><i class="fa fa-check"></i>&nbsp;Save</button>
